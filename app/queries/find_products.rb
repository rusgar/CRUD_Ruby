class FindProducts
    attr_reader :products   # https://www.rubyguides.com/2018/11/attr_accessor/
    def initialize(products = initialize_scope)
        @products = products
    end 
    ...
    def filter_by_category_id(scoped, category_id)
        return scoped unless category_id.present?    #sino encuentra la categoria devuelve todo lo que hay
 ...
 # Si no le  pasamos nada al constructor llamamos al metodo, en este caso es el Product.with_attached_photo
 # y el valor lo guardamos en una  variable de instancia y hacemos una llamada "call"
